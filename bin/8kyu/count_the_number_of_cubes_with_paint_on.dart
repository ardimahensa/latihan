...
///The interviewer then proceeds to cut through the cube in all three
///dimensions a certain number of times. Your function takes as parameter
///the number of times the cube has been cut. You must return the number
...
int countSquares(int cuts) => 6 * cuts * cuts + 2;
